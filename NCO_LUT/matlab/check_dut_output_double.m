...
system('cd ../vitis_hls && vitis_hls -f run_hls_double.tcl');

% get Vitis C-sim DUT output
output_from_dut_real = readFromC("../vitis_hls/proj_double/solution/csim/build/dut_output_real.bin");
output_from_dut_imag = readFromC("../vitis_hls/proj_double/solution/csim/build/dut_output_imag.bin");
